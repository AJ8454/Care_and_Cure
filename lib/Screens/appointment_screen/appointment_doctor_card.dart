            ...
            children: [
              ...
              Row(
                children: [
                  BookTimeBox(
                      time: '10:00',
                      color: timeSelected1! ? Colors.green[200] : Colors.white,
                      onClicked: () {
                        setState(() {
                  ...
                  BookTimeBox(
                      time: '12:00',
                      color: timeSelected2! ? Colors.green[200] : Colors.white,
                      onClicked: () {
                        setState(() {
                  ...
                  BookTimeBox(
                      time: '2:00',
                      color: timeSelected3! ? Colors.green[200] : Colors.white,
                      onClicked: () {
                        setState(() {
                  ...
                  BookTimeBox(
                      time: '4:00',
                      color: timeSelected4! ? Colors.green[200] : Colors.white,
                      onClicked: () {
                        setState(() {
                  ...
                  BookTimeBox(
                      time: '6:00',
                      color: timeSelected5! ? Colors.green[200] : Colors.white,
                      onClicked: () {
                        setState(() {
